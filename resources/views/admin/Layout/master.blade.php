...
<head>
  ...
  <link rel="stylesheet" href="assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css"> -->
    ...
    <!-- End layout styles -->
    <link rel="stylesheet" href="{{ asset('/dist/assets/images/favicon.png') }}">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo" href=""><img
                        src="https://banner2.cleanpng.com/20180406/uyq/kisspng-e-commerce-computer-icons-shopping-cart-software-o-shopping-cart-5ac7d1298aeb00.573537981523044649569.jpg"
                        alt="logo" /></a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list"
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="/dist/assets/images/faces/face4.jpg" alt="image"
                                        class="profile-pic">
                                </div>
                                <div
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="/dist/assets/images/faces/face2.jpg" alt="image"
                                        class="profile-pic">
                                </div>
                                <div
                                    class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="/dist/assets/images/faces/face3.jpg" alt="image"
                                        class="profile-pic">
                                </div>
                                <div
                                    class="preview-item-content d-flex align-items-start flex-column justify-content-center">
